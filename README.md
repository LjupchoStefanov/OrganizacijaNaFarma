...
* **Основен извештај** - приказ на одредени поосновни податоци за секој месец од годината
...
Се прикажуваат бројот на живородени прасиња, мртвородени прасиња, невитални прасиња и одбиени прасиња за секој месец поединечно и за цела година:
...
Преку класата ```public class DataAcess``` се овозможува конекција на работната околина и базата со податоци преку конекциски стринг од серверот на кој е прикачена. Оваа класа содржи метод за извршување на одредена команда (Sql) во базата со податоци.
```csharp
